...
import com.oracle.adw.repository.entity.Estate_Real_Apt_Trx_Keys;
...
@Repository
public interface EstateRealTrxAptRepository extends JpaRepository<Estate_Real_Apt_Trx, Estate_Real_Apt_Trx_Keys> {
    //@Modifying
